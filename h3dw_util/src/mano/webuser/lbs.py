...
def verts_core(pose, v, J, weights, kintree_table, want_Jtr=False, xp=chumpy):
    ...
    v = v[:,:3]
    for tp in [745, 320, 444, 555, 657]:  # THUMB, INDEX, MIDDLE, RING, PINKY
        A_global.append(xp.vstack((xp.hstack((np.zeros((3, 3)), v[tp, :3].reshape((3, 1)))), xp.array([[0.0, 0.0, 0.0, 1.0]]))))
