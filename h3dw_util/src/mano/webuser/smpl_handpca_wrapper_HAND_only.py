...
def load_model(fname_or_dict='./models/MANO_RIGHT.pkl', ncomps=6, flat_hand_mean=False, v_template=None):
    ...
    # hands_components = np.eye(45)

    # print(hands_components)
    ...
    # print('HO3D: hands_mean', hands_mean)
    # print("HO3D: hands_coeffs", hands_coeffs)

    # print("hand_components", hands_components.shape)
