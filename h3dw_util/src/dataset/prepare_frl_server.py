...
def process_frl_single(process_id, seq_name_list, all_data, res_anno_dir, res_img_dir, res_vis_dir):
    ...
    for seq_id, seq_name in enumerate(seq_name_list):
        ...
        for key_id, key in enumerate(all_imgs):
            ...
            res_img_path = osp.join(res_cam_subdir,  f"image{img_id:04d}.png")
...
def main():
    origin_data_dir = "/mnt/home/tshiratori/plan_to_move/data/Handsy_v2/m--20190925--1546--1738724--pilot--handsyv2/adhoc/"    
    all_data = load_data(origin_data_dir)

    res_anno_dir = "data_processed/annotation"
    res_img_dir =  "data_processed/image"
    res_vis_dir = "data_processed/image_anno"
