...
from temporal.strategy import copy_and_paste
from temporal.strategy import update_wrist
from temporal.strategy import average_frame
...
class TemporalModel(object):
    ...
    def _init_model(self):
        ...
        elif self.strategy == "update_wrist":
    ...
    def update_sample(self):
        if self.strategy == 'copy_and_paste':
            ...
            samples_new = update_wrist.apply(self)
