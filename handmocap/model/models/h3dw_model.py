...
from . import resnet
from models.h3dw_networks import H3DWEncoder
...
class H3DWModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.success_load = self.load_from_checkpoint(self.encoder, opt.checkpoint_path)
    ...
    def backward_E(self):
        ...
        # loss for regularize 
        self.shape_reg_loss = self.loss_util._shape_reg_loss(
            self.pred_shape_params)
        self.shape_reg_loss *= self.opt.shape_reg_weight
    ...
    def get_pred_result(self):
        ...
        pred_result = OrderedDict(
            ...
            gt_joints_2d = self.keypoints.cpu().numpy(),
            pred_joints_2d = self.pred_joints_2d.cpu().numpy()
        )
        return pred_result
